import{s as r,j as e,F as s,a,L as d}from"./index.cf61390d.js";import{p as i}from"./posts.53b0f0bf.js";import{H as n,L as c,R as m}from"./Routes.c2f97b2e.js";import{R as l,C as o}from"./Containers.9fbc6f6c.js";function h(){return e(s,{children:e(p,{children:i.length&&i.map(t=>a(g,{className:"card",children:[e(x,{children:e("img",{src:`./images/${t.img}`,alt:"react"})}),a(f,{children:[e(n,{upper:!0,size:"0.6em",color:"#000000",bolder:!0,spacing:"3px",p:"1em",children:t.title}),e(u,{}),a(b,{children:["Published on: ",t.date," by ",t.author]}),e(w,{children:e(d,{className:"post__link",to:`/post/${t.id}`,children:"Read more"})})]})]},t.id))})})}const p=r.div`
  display: flex;
  flex-wrap: wrap;
  max-width: 700px;
