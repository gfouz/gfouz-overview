  ...
  return (
    <>
      <Layout options={Routes} bg='#0b514c' lbg='#f5f5f5'>
        <WorkContainer>
            <Headline center upper p='2em 0 0 0' spacing='7px'>Gfouz</Headline>
            ...
            <CardContainer>
           {
            ...
            <Card key={index} className={`card ${item.card}`}>
              ...
              <Headline center upper bolder color='#999999'> Overview of my own opinion about technologies </Headline>
              <Paragraph  p='1em 0.5em 4em 0.5em' fontfam='calibri'>{attached}</Paragraph>              
           <LogoContainer>
